...
IT5.10 & LogController & log & Start the Spring server, then use the administration panel to power on and off the protocol servers. Try to access one of the protocols before and after power on/off & The protocol servers should not respons after power off, and vice versa. & Success \\ \hline
IT5.11 & LogController & logFilesAvailable & Start the Spring server, then use the administration panel to power on and off the protocol servers. Try to access one of the protocols before and after power on/off & The protocol servers should not respons after power off, and vice versa. & Success \\ \hline

IT5.12 & LogController & logLevelsAvailable & Start the Spring server and access the  & The protocol servers should not respons after power off, and vice versa. & Success \\ \hline
...
ST3.1 & WSN & Protocol standards compliance & Send a message using WS-BaseNotitication, and a message using WS-BrokeredNotification. & The system accepts both namespace types and distributes them correctly. & ? \\ \hline
\end{tabular}
