...
%\item Network connectivity. Verify that your network connection is working and that the %ports are open. Also ensure that you use port forwarding if you do not have a public IP. 
%\end{itemize}
