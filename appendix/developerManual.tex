...
The front-end of OKSE is the only component of the system accessible for user interaction. It is responsible for making HTTP-requests to the backend to manipulate and present the state of OKSE. Each pane of the administration pane has its own JavaScript module. 
