...
Overall, the development period worked out well. The main issues were with resource and time management. Not enough work was devoted to the project in the early stages of the process. This proved to be an issue later on, especially due to the task being more difficult than the initial assessment. Although this was sub-optimal, the issue was solved by adding more hours towards the end of the project. Emphasis put on test-driven development was drastically reduced as the project went on, but it did not affect the product in a considerable way. TDD aside, the Scrum process model and methodology worked well. Below is a diagram showing the work distribution among the major tasks (figure \ref{fig:kake2}), along with the final development burndown chart (figure \ref{fig:release-burndown}).
...
The final burndown chart only considers development work done in the sprints. Note that research work and report writing were also executed during the sprints, but are not reflected in the burndown charts.
...
This created additional challenges, as best practices and documentation were hard to come across. Through much research, trial and error, the group eventually managed to overcome most of these challenges.
