...
\begin{center}
  \begin{figure}[ht!]
    \makebox[\textwidth]{\includegraphics[width=0.9\textwidth]{fig/WBS.png}}
...
Table \ref{fig:available_time} shows the time that was available. This was meant as a supplement to the Gantt diagram, providing a simple overview of the planned time usage. It accounts for Easter, as well as other holidays. Figure \ref{fig:Main structure diagram} shows the distribution among the different packages from the WBS.
\begin{table}[t]
\centering
...
Iteration 3                 & 23/03/2015    & 01/04/2015    & 8 days        & 96 hours \footnote{Easter holiday and adjusted for the leave of absence of three group members (USA)}  \\ \hline
...
Final phase                 & 22/05/2015    & 30/05/2015    & 8 days       & 192 hours \\ \hline
